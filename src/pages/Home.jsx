                ...
                <div className="inner-container">
                  <div className="top-left">
                    <ul className="contact-list clearfix">
                      <li>
                        <i className="flaticon-hospital-1"></i>234 Triumph, Los
                        Angeles, California, US{" "}
                      </li>
                      <li>
                        <i className="flaticon-back-in-time"></i>Mon - Sat 8.00
                        - 18.00. Sunday CLOSED
                      </li>
                    </ul>
                  </div>
          ...
          <section className="banner-section-one">
            <div className="banner-carousel owl-carousel owl-theme default-arrows dark owl-loaded owl-drag">
              ...
              >
                ...
                >
                  <div className="owl-item cloned" style={{ width: "1519px" }}>
                    <div
                  ...
                  <div className="owl-item active" style={{ width: "1519px" }}>
                    <div
                      className="slide-item"
                      style={{
                        backgroundImage: `url('/images/main-slider/1.jpg')`,
              ...
              <div className="row">
                <div className="feature-block col-lg-4 col-md-6 col-sm-12">
                  <div className="inner-box">
                    ...
                    <p>
                      Our Delmont hospital utilizes state of the art technology
                      and employs a team of true experts.
                    </p>
                  </div>
                </div>
                <div className="feature-block col-lg-4 col-md-6 col-sm-12">
                    ...
                    >
                      ...
                      >
                        <div className="testimonial-block">
                          <div className="inner-box">
                            <div className="text">
                              Medical Centre is a great place to get all of your
                              medical needs. I came in for a check up and did
                              not wait more than 5 minutes before I was seen. I
                              can only imagine the type of service you get for
                              more serious issues. Thanks!
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="footer-column col-xl-7 col-lg-6 col-md-6 col-sm-12">
                        <div className="footer-widget about-widget">
                          ...
                          <div className="text">
                            <p>
                              Our Clinic has grown to provide a world className
                              facility for the clinic advanced restorative.{" "}
                            </p>
                            <p>
                              We are among the most qualified implant providers
                              in the AUS with over 30 years of quality training
                              and experience.
                            </p>
                          </div>
          ...
          <div className="inner-palate">
            ...
            <div className="lower-options">
              ...
              <ul className="box-version option-box">
                {" "}
                <li className="active">Wide</li> <li className="box">Boxed</li>{" "}
              </ul>
